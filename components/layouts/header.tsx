    ...
    return (
        <header className={`z-40 ${themeConfig.semidark && themeConfig.menu === 'horizontal' ? 'dark' : ''}`}>
            <div className="shadow-sm">
                <div className="relative lg:p-0 flex w-full items-center bg-white px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo lg:py-8px flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                    ...
                    <div className="hidden ltr:mr-2 rtl:ml-2">
                    ...
                    <div className="flex items-center justify-end space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                        <div className="sm:ltr:mr-auto sm:rtl:ml-auto hidden">
                            <form
                        ...
                        <div className="horizontal-logo dropdown flex shrink-0 lg:hidden pr-4">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                ...
                                <ul className="w-[150px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                    ...
                                    <li>
                                        <Link href="/apps/mailbox" className="dark:hover:text-white">
                                            <IconSetting className="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" fill={isDarkMode ? "white" : "black"}/>
                                            Setting
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/auth/boxed-lockscreen" className="dark:hover:text-white">
                                            <IconLogout className="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" fill={isDarkMode ? "white" : "black"}/>
                                            Logout
                                        </Link>
                                    </li>
                                </ul>
